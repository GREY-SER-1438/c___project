...
void FuelCompartment1Location::run() {
    ...
    if (choice1 == 1) {
        ...
        switch (itemChoice) {
            case 1:
                cout << "\x1B[31mВы берёте перчатки.\x1B[0m Они потрёпаны, но ещё служат защитой от копоти.\n\n";
    ...
    cout << "Чтобы понять, что все-таки произошло, вы направляетесь ко двери в комнату мониторинга.\n"
            "Может, диагностика системы прольёт свет на всю ситуацию?\n\n";
