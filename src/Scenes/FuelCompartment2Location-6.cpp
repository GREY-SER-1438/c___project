...
void FuelCompartment2Location::run() {
    ...
    switch (choice) {
        case 1:
            cout <<
                 "\n\x1B[31mВы осторожно отодвигаете плиту, стараясь не задеть лужу.\x1B[0m\n"
        ...
        case 2: {
            cout << "\n\x1B[31mВы резко поднимаете плиту...\x1B[0m\n";
            int r = rand() % 2;
    ...
    if (!catalystDestroyedEarly && canReachCatalyst) {
        ...
        switch (choice2) {
            case 1:
                cout <<
                     "\n\x1B[31mВы пытаетесь поднять катализатор, но едкий осадок прожигает кожу.\x1B[0m\n"
            ...
            case 2:
                cout <<
                     "\n\x1B[31mВы активируете защитный модуль.\x1B[0m\n"
            ...
            case 3: {
                cout <<
                     "\n\x1B[31mНа панели продувки мигают старые, потускневшие индикаторы.\x1B[0m\n"
                ...
                switch (blow) {
                    case 1:
                        cout <<
                             "\n\x1B[31mСлабый поток аккуратно сдувает осадок.\x1B[0m\n"
                    ...
                    case 2:
                        cout <<
                             "\n\x1B[31mСильная струя сбивает катализатор в сторону.\x1B[0m\n"
        ...
        cout <<
             ...
             "К сожалению, шанс был только один.\n\n";
    }
    ...
    switch (exitChoice) {
        case 1:
            cout <<
                 "\n\x1B[31mВы начинаете разбирать завал.\x1B[0m Металл ломается легко,\n"
        ...
        case 2:
            cout <<
                 "\n\x1B[31mВы надеваете скафандр и открываете аварийный шлюз.\x1B[0m\n"
