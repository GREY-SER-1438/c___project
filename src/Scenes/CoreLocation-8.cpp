...
{
    cout << "\n\x1B[31m=== ЦЕНТРАЛЬНОЕ ЯДРО ===\x1B[0m\n";
    ...
    if (game.hasResearchDisk)
    {
        ...
        cout << "\x1B[31mДиск установлен.\x1B[0m Панель загружает данные, интерфейс оживает.\n\n";
    ...
    if (game.catalystObtained)
    {
        ...
        cout << "\x1B[31mКатализатор встает в паз.\x1B[0m Контур стабилизируется, разряды гаснут.\n\n";
    ...
    if (game.oxygenChipObtained)
    {
        ...
        cout << "\x1B[31mМикросхема подключена.\x1B[0m Фильтры запускаются, поток воздуха выравнивается.\n\n";
